...
class Person : public ::google::protobuf::Message {
 public:
  ...
  inline ::google::protobuf::uint32 old() const;
  inline void set_old(::google::protobuf::uint32 value);
...
// optional uint32 old = 2;
inline bool Person::has_old() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void Person::set_has_old() {
  _has_bits_[0] |= 0x00000002u;
}
inline void Person::clear_has_old() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void Person::clear_old() {
  old_ = 0u;
  clear_has_old();
}
inline ::google::protobuf::uint32 Person::old() const {
  // @@protoc_insertion_point(field_get:Person.old)
  return old_;
}
inline void Person::set_old(::google::protobuf::uint32 value) {
  set_has_old();
  old_ = value;
  // @@protoc_insertion_point(field_set:Person.old)
}
